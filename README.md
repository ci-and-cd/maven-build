...
#### B.1. local install/deploy maven-build
    ...
    cp src/main/maven/settings-global.xml ~/.m2/wrapper/dists/topinfra-maven-dist-0.0.1-20190709.080850-29/1abvl8q8gnetbhuffisivcef93/apache-maven-3.6.1/conf/settings.xml
