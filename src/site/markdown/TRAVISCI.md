...
`travis login` or `travis login --github-token $CI_OPT_OPENSOURCE_GIT_AUTH_TOKEN`
...
* see: [Publishing a Maven Site to GitHub Pages with Travis-CI](https://blog.lanyonm.org/articles/2015/12/19/publish-maven-site-github-pages-travis-ci.html)
    ...
    travis encrypt CI_OPT_OPENSOURCE_GIT_AUTH_TOKEN="${CI_OPT_OPENSOURCE_GIT_AUTH_TOKEN}" --add env.global
...
## Deploy to github releases
    ...
    deploy:
      provider: releases
      api_key: $CI_OPT_OPENSOURCE_GIT_AUTH_TOKEN
